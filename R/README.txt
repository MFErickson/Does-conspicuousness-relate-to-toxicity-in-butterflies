...
4.brms.R: run brms model for ventral and dorsal time and plots predicted relationship.
5.brms2.R: run brms model for detection difference and plots predicted relationship.
